...
echo ============================================
echo HermesX AutoFlasher Windows Build Round 3
echo ============================================
...
echo [STEP 1] Check paths
echo --------------------------------------------
if not exist "%ROOT%" echo [ERROR] ROOT not found.
if not exist "%BUILD_PS1%" echo [ERROR] build.ps1 not found.
echo.

echo [STEP 2] Check py launcher
echo --------------------------------------------
py -0p
echo.

echo [STEP 3] Recreate clean Python 3.13 venv
echo --------------------------------------------
if exist "%VENV%" (
  rmdir /s /q "%VENV%"
)
...
echo [STEP 5] Verify Python executable
echo --------------------------------------------
...
echo [STEP 7] Build Windows executable
echo --------------------------------------------
powershell -ExecutionPolicy Bypass -File "%BUILD_PS1%" -PythonExe "%PYTHON%"
echo BUILD_EXIT_CODE=%ERRORLEVEL%
echo.

echo [STEP 8] Test built executable help
echo --------------------------------------------
if exist "%OUT_EXE%" (
  "%OUT_EXE%" --help
