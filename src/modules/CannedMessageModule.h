...
enum cannedMessageReturnTarget {
    ...
    CANNED_MESSAGE_RETURN_TARGET_FINDER_LIST,
    CANNED_MESSAGE_RETURN_TARGET_FINDER_DETAIL,
    CANNED_MESSAGE_RETURN_TARGET_GROUP_LIST,
    CANNED_MESSAGE_RETURN_TARGET_GROUP_DETAIL,
};
...
class CannedMessageModule : public SinglePortModule, public Observable<const UIFrameEvent *>, private concurrency::OSThread
{
  ...
  public:
    ...
    void ensureCancelOption(); // 確保選單中有取消項
    // void eventUp();
    // void eventDown();
    // void eventSelect();
