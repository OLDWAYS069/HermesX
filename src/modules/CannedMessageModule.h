...
class CannedMessageModule : public SinglePortModule, public Observable<const UIFrameEvent *>, private concurrency::OSThread
{
  ...
  public:
    ...
    size_t getEmergencyMenuEntryCount() const;
    bool getEmergencyMenuEntry(size_t index, const char *&label, meshtastic_EmergencyType &type) const;
#endif
  ...
  protected:
    ...
    void requestCannedFocus();
    void notifyUiFrameEvent(UIFrameEvent &evt);
