...
void setupModules()
{
    const bool isColorDisplay = config.display.displaymode == meshtastic_Config_DisplayConfig_DisplayMode_COLOR;
    const bool forceInputOnColor = true; // Treat color builds like monochrome so InputBroker/rotary still init

#if (HAS_BUTTON || ARCH_PORTDUINO) && !MESHTASTIC_EXCLUDE_INPUTBROKER
    if (!isColorDisplay || forceInputOnColor) {
