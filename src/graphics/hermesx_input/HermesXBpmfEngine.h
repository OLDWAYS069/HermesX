#pragma once
#include "HermesXBpmfComposer.h"
#include "HermesXZhuyinTrieHelpers.h"
#include <string>
#include <vector>
...
//  repeating the search. A UI owns an HermesXBpmfEngine, feeds it keys, draws
...
//
//    HermesXBpmfEngine owns it (physical keyboards)
...
class HermesXBpmfEngine
{
  public:
    ...
    bool addSymbol(const HermesXBpmfSymbol &sym) { return composer_.addSymbol(sym); }
