...
本次架構重整的產品版號升為 `HXB_C0.4.0`，工作分支為 `HermesX_C0.4.0`。CIV 關閉 EMAC，但保留 GROUP 與尋人模組。
...
| `HermesX_C0.4.0` | `CIV` | 關閉 | 啟用 | `MESHTASTIC_EXCLUDE_LIGHTHOUSE=0`, `HERMESX_CIV_DISABLE_EMAC=1` |
